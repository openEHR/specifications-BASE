...
|[[latest_issue]]1.2.2
|{openehr_jira}/SPECBASE-21[SPECBASE-21]. Update Architecture Overview with new LANG component, and improved explanation of ITS. Improve package structure description. Replace some diagrams.
|T Beale
