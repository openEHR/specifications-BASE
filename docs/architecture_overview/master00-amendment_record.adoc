...
|[[latest_issue]]1.3.1
| Complete the `_system_id_` documentation for {spec_tickets}/SPECPR-392[SPECPR-392^]: correct a residual `net.nhs.rmh` mention to `uk.nhs.ehr1` in a version-identifier example, and add non-normative guidance on the common forms of `_system_id_` (reverse domain name, UUID/GUID or ISO OID).
|J Zeilstra, +
S Iancu
|[[latest_issue_date]]25 Jul 2026
