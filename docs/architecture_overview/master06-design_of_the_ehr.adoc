...
image::diagrams/minimal_openehr_system.png[minimal_openehr_system,align="center",width="70%"]
...
image::{openehr_rm_uml_export}/diagrams/RM-composition.entry-simple.svg[id=entry_model_simple, align="center",width="60%"]
...
image::{openehr_rm_releases_diags}/docs/ehr/diagrams/clinical_investigator_recording_process.svg[clinical_investigator_process,align="center",width="65%"]
...
image::{openehr_rm_uml_export}/diagrams/RM-InstructionStateMachine.svg[instruction_state_machine,align="center"]
