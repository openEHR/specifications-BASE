...
image::{diagrams_uri}/minimal_openehr_system.png[minimal_openehr_system,align="center",width="80%"]
...
image::{rm_uml_export_dir}/diagrams/RM-composition.entry-simple.svg[id=entry_model_simple, align="center",width="60%"]
...
image::{diagrams_uri}/clinical_investigator_process.png[clinical_investigator_process,align="center",width="80%"]
...
image::{diagrams_uri}/instruction_state_machine.png[instruction_state_machine,align="center"]
