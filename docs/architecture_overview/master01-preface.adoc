...
This specification is in the {spec_status} state. The development version of this document can be found at {openehr_overview}[{openehr_domain}/releases/BASE/latest/architecture_overview.html].
