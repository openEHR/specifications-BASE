...
in citenp:[Beale2002]. Under the two-level approach, a stable reference information model constitutes the first level
...
image::{diagrams_uri}/archetype_meta_architecture.png[id=archetype_meta_architecture, align="center", width=80%]
...
image::{diagrams_uri}/two_level_engineering.png[id=two_level_engineering, align="center", width=80%]
...
into broad areas of interest, i.e. into a 'system of systems' cite:[Maier2000]. This principle has been understood in
...
image::{diagrams_uri}/health_information_environment.png[id=health_information_environment, align="center"]
...
viewpoint. For example, there might be a concept of 'health mandate' (an <<ISO_13940,ISO 13940>> Continuity
