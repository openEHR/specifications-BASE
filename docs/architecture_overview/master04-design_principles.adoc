...
image::diagrams/two_level_engineering.svg[id=two_level_engineering, align="center"]
...
into broad areas of interest, i.e. into a 'system of systems' <<Maier_2000>>. This principle has been understood in
