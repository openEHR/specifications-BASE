...
image::diagrams/spec_component-base.svg[id=spec_component_base, align="center", width=75%]
...
image::diagrams/spec_component-lang.svg[id=spec_component_lang, align="center", width=80%]
...
image::diagrams/spec_component-rm.svg[id=spec_component_rm, align="center", width=70%]
...
image::{openehr_rm_uml_export}/diagrams/RM-packages.svg[id=rm_packages, align="center"]
...
image::{openehr_am_uml_export}/diagrams/AOM-packages.svg[id=aom_2_packages, align="center"]

The package structure of the version 1.4 form of the AM is shown below.

[.text-center]
.Structure of the ADL 1.4 `org.openehr.am` package
image::{openehr_am_uml_export}/AOM1.4/diagrams/AOM-packages.svg[id=aom_14_packages, align="center"]
