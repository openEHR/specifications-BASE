...
The second way to identify a top-level structure is by using an exact Version identifier, which takes the form
`object_id::creating_system_id::version_tree_id`. This leads to URIs like the following:
