...
The possible values for `top_level_structure_locator` are a subset of the attribute names on the class `EHR`, http://www.openehr.org/releases/RM/{release}/ehr.html#\_ehr_package[visible in the ehr package], namely `_compositions_`, `_ehr_status_`, `_ehr_access_`, and `_directory_`.
...
ehr:/347a5490-55ee-4da9-b91a-9bba710f730e/directory/207fbb0f-cc90-41ce-ab64-22bddbcd1e2c
----
