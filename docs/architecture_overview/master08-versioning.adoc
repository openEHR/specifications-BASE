...
image::{diagrams_uri}/contribution_deltas.png[id=contribution_deltas, align="center", width=80%]
...
image::{diagrams_uri}/contributions_non_delta.png[id=contributions_non_delta, align="center", width=80%]
