...
[.text-center]
.Version Signature
image::{diagrams_uri}/version_control_structures.png[version_control_structures,align="center", width=80%]
...
image::{diagrams_uri}/controlled_repository.png[controlled_repository,align="center", width=55%]
...
image::{diagrams_uri}/contribution_deltas.png[contribution_deltas, align="center", width=80%]
...
image::{diagrams_uri}/contributions_non_delta.png[contributions_non_delta, align="center", width=80%]
...
image::{diagrams_uri}/abstract_model_repository.png[abstract_model_repository,align="center", width=60%]
