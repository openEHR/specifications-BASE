...
image::{diagrams_uri}/system_architecture.png[system_architecture,align="center", width=70%]
...
image::{diagrams_uri}/software_arch_deployment.png[software_arch_deployment,align="center", width=70%]
