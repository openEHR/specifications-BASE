...
include::master05-core-structure.adoc[leveloffset=+1]
include::master06-core-entities.adoc[leveloffset=+1]
include::master07-persistence.adoc[leveloffset=+1]
include::master08-syntax.adoc[leveloffset=+1]
