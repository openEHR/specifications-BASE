...
h|*Description*
2+a|Type reference that specifies containers with one generic parameter, and whose outer type is guaranteed to be a primitive container generic type such as List<>, Hash<> etc.
