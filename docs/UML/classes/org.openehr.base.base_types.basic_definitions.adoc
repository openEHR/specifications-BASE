...
h|*1..1*
|*CR*: `link:/releases/BASE/{base_release}/foundation_types.html#_character_class[Character^]{nbsp}={nbsp}'\015'`
a|Carriage return character.

h|*1..1*
|*LF*: `link:/releases/BASE/{base_release}/foundation_types.html#_character_class[Character^]{nbsp}={nbsp}'\012'`
