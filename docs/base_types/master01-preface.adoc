...
This specification is in the {spec_status} state. The development version of this document can be found at {openehr_base_types}[{openehr_domain}/releases/BASE/latest/base_types.html].
