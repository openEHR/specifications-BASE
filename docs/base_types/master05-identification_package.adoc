...
* `_object_id_`: the identifier of the version container, in the form of a UID, typically a Guid;
...
include::{uml_export_dir}/classes/uid.adoc[]

include::{uml_export_dir}/classes/iso_oid.adoc[]

include::{uml_export_dir}/classes/uuid.adoc[]

include::{uml_export_dir}/classes/internet_id.adoc[]

include::{uml_export_dir}/classes/object_id.adoc[]

include::{uml_export_dir}/classes/uid_based_id.adoc[]

include::{uml_export_dir}/classes/hier_object_id.adoc[]

include::{uml_export_dir}/classes/object_version_id.adoc[]

include::{uml_export_dir}/classes/version_tree_id.adoc[]

include::{uml_export_dir}/classes/archetype_id.adoc[]

include::{uml_export_dir}/classes/template_id.adoc[]

include::{uml_export_dir}/classes/terminology_id.adoc[]

include::{uml_export_dir}/classes/generic_id.adoc[]

include::{uml_export_dir}/classes/object_ref.adoc[]

include::{uml_export_dir}/classes/party_ref.adoc[]

include::{uml_export_dir}/classes/locatable_ref.adoc[]
