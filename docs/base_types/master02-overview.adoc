...
The openEHR Base Types (`org.openehr.base_types` package) consists of foundational types used throughout the openEHR specifications, including types assumed to exist outside of the openEHR type system, e.g. by implementation formalisms. 
