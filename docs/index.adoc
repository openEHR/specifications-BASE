...
|link:/releases/BASE/{base_release}/architecture_overview.html[The openEHR Architecture Overview]
...
|link:/releases/BASE/{base_release}/odin.html[Object Data Instance Notation (ODIN)]
