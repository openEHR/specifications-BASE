...
|[[latest_issue]]1.10.2
|{spec_tickets}/SPECBASE-48[SPECBASE-48^]: Add `RESOURCE_DESCRIPTION` invariants (`Original_author_valid`, `Lifecycle_state_valid`, `Parent_resource_valid`) that were missing from the source BMM.
|S Iancu
|[[latest_issue_date]]22 Jun 2026
