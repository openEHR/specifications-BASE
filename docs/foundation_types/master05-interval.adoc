...
The following UML diagram illustrates the `foundation_types.interval` package.

[.text-center]
.foundation_types.interval package
image::{uml_export_dir}/diagrams/BASE-foundation_types.interval.svg[id=foundation_types_interval, align="center"]
