...
include::{uml_export_dir}/classes/{pkg}routine.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}function.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}procedure.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}tuple.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}tuple1.adoc[leveloffset=+1]

include::{uml_export_dir}/classes/{pkg}tuple2.adoc[leveloffset=+1]
