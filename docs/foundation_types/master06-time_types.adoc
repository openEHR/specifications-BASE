...
* partial variants of `Iso8601_date_time` can include missing hours, days and months, whereas {iso_8601}[ISO 8601:2004] (section 4.3.3 c) only allows missing seconds and minutes. The reasons for this deviation are:
