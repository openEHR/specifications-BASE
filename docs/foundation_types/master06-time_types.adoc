...
* The time `24:00:00` (or `240000`) is not allowed anywhere, whereas in ISO 8601:2019 it appears to be legal at least for pure times. This deviation also appears to be used in HL7v2 and HL7v3 (where midnight is defined as the time `00:00:00`), and is preferable to the documented standard, since a date/time with time of `24:00:00` is really the next day, i.e. the date part is then incorrect.
