...
See {iso_8601}[ISO 8601] and the {iso8601_official}[official ISO 8601 standard] for details. Note that in the date, time and date_time formats shown below, 'Z' and 'T' are literals.  In the duration class shown below, 'P', 'Y', 'M', 'W', 'D', 'H', 'S' and 'T' are literals.
