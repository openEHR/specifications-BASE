...
|[[latest_issue]]1.3.3
| Correct documentation typos in the Overview and Time types, and remove the repeated meaning text in the `Interval` `_intersects_` and `_contains_` function documentation ({spec_tickets}/SPECPR-458[SPECPR-458^], {spec_tickets}/SPECPR-459[SPECPR-459^]).
|R Kavanagh
