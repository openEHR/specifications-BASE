...
|`Iso8601_Date`         |ISO8601-encoded date type.             |`date`         |use `java.text.SimpleDateFormat` +
                                                                                 or `org.joda.time.format.ISODateTimeFormat`  
                                                                                                    |(use formatted string)
                                                                                 
|`Iso8601_Time`         |ISO8601-encoded time type.             |`time`         |use j`ava.text.SimpleDateFormat` +
                                                                                 or `org.joda.time.format.ISODateTimeFormat`
                                                                                                    |(use formatted string)
                                                                                 
|`Iso8601_Date_time`    |ISO8601-encoded date/time type.        |`dateTime`     |use `java.text.SimpleDateFormat` +
                                                                                 or `org.joda.time.format.ISODateTimeFormat`  
                                                                                                    |(use formatted string)
                                                                                 
|`Iso8601_Duration`     |ISO8601-encoded duration type.         |`duration`     |use `java.text.SimpleDateFormat` +
                                                                                 or `org.joda.time.format.ISODateTimeFormat`  
                                                                                                    |(use formatted string)
