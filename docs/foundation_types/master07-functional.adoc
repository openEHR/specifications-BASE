...
The following illustrates the `foundation_types.functional` package.

[.text-center]
.foundation_types.functional package
image::{uml_export_dir}/diagrams/BASE-foundation_types.functional.svg[id=foundation_types_functional, align="center"]
