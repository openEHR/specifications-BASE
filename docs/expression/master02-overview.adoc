...
Functions and procedures may be declared and invoked within the main text. These are bound to methods from external libraries in a `computing_bindings` section. 
