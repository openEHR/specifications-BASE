...
Constants of complex types are declared using the ODIN syntax, for example:
...
Functions are mapped to class methods in external libraries in the <<_computing_bindings, Computing Bindings>> section of an EL text.
...
data_context
    in $systolic_bp_samples: List<Real>
