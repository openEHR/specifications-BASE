...
:openehr_sm_releases: http://www.openehr.org/releases/SM/{sm_release}
:openehr_sm_uml_diagrams: {openehr_sm_releases}/docs/UML/diagrams
:openehr_sm_openehr_platform: {openehr_sm_releases}/openehr_platform.html

:openehr_query_releases: http://www.openehr.org/releases/QUERY/{query_release}
:openehr_query_aql: {openehr_query_releases}/AQL.html

:openehr_proc_releases: http://www.openehr.org/releases/PROC/{proc_release}
...
:openehr_jira_prs: {openehr_jira}/projects/SPECPR/issues
