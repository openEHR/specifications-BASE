...
:openehr_terminology_resources: {openehr_git}/openEHR/terminology
...
:soap_protocol: https://en.wikipedia.org/wiki/SOAP
:rest_ws: https://en.wikipedia.org/wiki/Representational_state_transfer
