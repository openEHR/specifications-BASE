...
One comprehensive statement of EHR requirements covering many of the above is the <<ISO_18308,ISO Technical
Report 18308>> for which an {openehr_18308}[openEHR profile has been created]. The requirements summarised above
are described in more detail in the {openehr_rm_ehr}[openEHR EHR Information Model specification].
