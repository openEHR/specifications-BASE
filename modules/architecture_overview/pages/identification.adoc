...
image::diagrams/ids_and_references.png[id=ids_and_references,align="center", width=50%]
...
image::diagrams/object_referencing.png[id=object_referencing,align="center", width=65%]
