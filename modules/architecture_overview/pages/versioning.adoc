...
[.text-center]
.Version Signature
image::diagrams/version_control_structures.png[id=version_control_structures,align="center", width=80%]
...
image::diagrams/controlled_repository.png[id=controlled_repository,align="center", width=55%]
...
image::diagrams/ehr_contributions_deltas.svg[id=contribution_deltas, align="center", width=80%]
...
image::diagrams/ehr_contributions_non_deltas.svg[id=contributions_non_delta, align="center", width=80%]
...
image::diagrams/abstract_model_repository.png[id=abstract_model_repository,align="center", width=60%]
