...
image::diagrams/security_features.png[id=security_features,align="center", width=80%]
...
[.text-center]
.Version Signature
image::diagrams/version_signature.png[id=version_signature,align="center", width=80%]
