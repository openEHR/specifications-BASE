...
image::diagrams/archetypes_and_data.png[id=archetypes_and_data,align="center", width=80%]
...
image::diagrams/archetype_use.png[id=archetype_use,align="center", width=80%]
...
image::diagrams/kernel.png[id=kernel,align="center", width=80%]
