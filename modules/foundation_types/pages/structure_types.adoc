...
[.text-center]
.`base.foundation_types.structures` package
image::ROOT:uml/BASE-foundation_types.structures.svg[id=foundation_types_structure_types, align="center"]

== Class Definitions

include::ROOT:partial$classes/container.adoc[]

include::ROOT:partial$classes/list.adoc[]

include::ROOT:partial$classes/set.adoc[]

include::ROOT:partial$classes/array.adoc[]

include::ROOT:partial$classes/hash.adoc[]
