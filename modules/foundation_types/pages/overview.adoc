...
image::ROOT:uml/BASE-foundation_types-packages.svg[id=foundation_types_packages, align="center"]
...
[.text-center]
.Leaf Types
image::ROOT:uml/BASE-foundation_types-leaf_types.svg[id=foundation_types_leaf_types, align="center"]

== Class Definitions

include::ROOT:partial$classes/any.adoc[]
