...
image::ROOT:uml/BASE-foundation_types.functional.svg[id=foundation_types_functional, align="center"]
...
include::ROOT:partial$classes/routine.adoc[]

include::ROOT:partial$classes/function.adoc[]

include::ROOT:partial$classes/procedure.adoc[]

include::ROOT:partial$classes/tuple.adoc[]

include::ROOT:partial$classes/tuple1.adoc[]

include::ROOT:partial$classes/tuple2.adoc[]
