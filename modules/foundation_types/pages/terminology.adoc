...
image::ROOT:uml/BASE-foundation_types.terminology.svg[id=foundation_types_terminology_types, align="center"]

== Class Definitions

include::ROOT:partial$classes/terminology_term.adoc[]

include::ROOT:partial$classes/terminology_code.adoc[]

include::ROOT:partial$classes/code_phrase.adoc[]
