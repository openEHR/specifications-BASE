...
h|*0..1*
|*annotations*: `xref:{class_resource_annotations}[RESOURCE_ANNOTATIONS]`
...
h|*0..1*
|*translations*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_translation_details}[TRANSLATION_DETAILS]>`
