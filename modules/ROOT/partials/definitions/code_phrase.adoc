...
h|*1..1*
|*terminology_id*: `xref:BASE:base_types:identification_package.adoc#_terminology_id_class[TERMINOLOGY_ID]`
...
h|*0..1*
|*preferred_term*: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
