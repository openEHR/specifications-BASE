...
h|*Inherit*
2+|`xref:BASE:base_types:identification_package.adoc#_object_ref_class[OBJECT_REF]`
...
h|*1..1 +
(redefined)*
|*id*: `xref:BASE:base_types:identification_package.adoc#_uid_based_id_class[UID_BASED_ID]`
...
h|*1..1*
|*as_uri* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
