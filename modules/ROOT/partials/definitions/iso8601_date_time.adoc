...
h|*Inherit*
2+|`xref:BASE:foundation_types:iso8601_time_package.adoc#_iso8601_type_class[Iso8601_type]`, `xref:BASE:foundation_types:time_types.adoc#_idate_time_class[IDate_time]`
...
h|*1..1*
|*as_date_time* (): `xref:BASE:foundation_types:time_types.adoc#_date_time_class[Date_time]`
