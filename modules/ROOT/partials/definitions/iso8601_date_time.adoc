...
h|*1..1*
|*minute_unknown* (): `xref:{class_boolean}[Boolean]`
a|Indicates whether minute in hour is known.

h|*1..1*
|*second_unknown* (): `xref:{class_boolean}[Boolean]`
a|Indicates whether minute in hour is known.
...
h|*1..1*
|*has_fractional_second* (): `xref:{class_boolean}[Boolean]`
...
): `xref:{class_iso8601_date_time}[Iso8601_date_time]`
...
): `xref:{class_iso8601_duration}[Iso8601_duration]`
a|Difference of two date/times.

h|*1..1*
|*add_nominal* __alias__ "++" ( +
a_diff: `xref:{class_iso8601_duration}[Iso8601_duration][1]` +
): `xref:{class_iso8601_date}[Iso8601_date]`
