...
): `xref:BASE:foundation_types:time_types.adoc#_iso8601_date_time_class[Iso8601_date_time]`
...
): `xref:BASE:foundation_types:time_types.adoc#_iso8601_duration_class[Iso8601_duration]`
a|Difference of two date/times.

h|*1..1*
|*add_nominal* __alias__ "++" ( +
a_diff: `xref:BASE:foundation_types:time_types.adoc#_iso8601_duration_class[Iso8601_duration][1]` +
): `xref:BASE:foundation_types:time_types.adoc#_iso8601_date_class[Iso8601_date]`
