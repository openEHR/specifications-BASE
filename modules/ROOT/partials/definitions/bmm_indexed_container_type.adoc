...
h|*Inherit*
2+|`xref:BASE:bmm:core_package.adoc#_bmm_container_type_class[BMM_CONTAINER_TYPE]`
...
h|*1..1*
|*index_type*: `xref:BASE:bmm:core_package.adoc#_bmm_simple_type_class[BMM_SIMPLE_TYPE]`
