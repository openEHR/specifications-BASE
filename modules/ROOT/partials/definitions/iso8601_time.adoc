...
h|*Inherit*
2+|`xref:BASE:foundation_types:iso8601_time_package.adoc#_iso8601_type_class[Iso8601_type]`, `xref:BASE:foundation_types:time_types.adoc#_itime_class[ITime]`
...
h|*1..1*
|*valid_iso8601_time* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*as_time* (): `xref:BASE:foundation_types:time_types.adoc#_time_class[Time]`
