...
h|*Inherit*
2+|`xref:{class_p_bmm_package_container}[P_BMM_PACKAGE_CONTAINER]`, `xref:{class_bmm_schema}[BMM_SCHEMA]`
...
h|*1..1*
|*canonical_packages* (): `xref:{class_p_bmm_package}[P_BMM_PACKAGE]`
