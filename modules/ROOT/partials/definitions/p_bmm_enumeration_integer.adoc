...
h|*Inherit*
2+|`xref:BASE:bmm_persistence_package.adoc#_p_bmm_enumeration_class[P_BMM_ENUMERATION]`
...
h|*0..1 +
(redefined)*
|*bmm_class*: `xref:BASE:bmm:core_package.adoc#_bmm_enumeration_integer_class[BMM_ENUMERATION_INTEGER]`
