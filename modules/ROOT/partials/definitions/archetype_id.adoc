...
h|*1..1*
|*qualified_rm_entity* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Globally qualified reference model entity, e.g.  `openehr-EHR-OBSERVATION`.

h|*1..1*
|*domain_concept* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Name of the concept represented by this archetype, including specialisation, e.g. `Biochemistry_result-cholesterol`.

h|*1..1*
|*rm_originator* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Organisation originating the reference model on which this archetype is based, e.g. openehr,  cen,  hl7 .

h|*1..1*
|*rm_name* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Name of the reference model, e.g. rim,  ehr_rm,  en13606 .

h|*1..1*
|*rm_entity* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
...
h|*1..1*
|*specialisation* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
