...
h|*0..1*
|*type_ref*: `xref:{class_p_bmm_open_type}[P_BMM_OPEN_TYPE]`
...
h|*0..1 +
(redefined)*
|*bmm_property*: `xref:{class_bmm_property}[BMM_PROPERTY]<link:/classes/BMM_OPEN_TYPE[BMM_OPEN_TYPE] >`
...
h|*1..1*
|*type_def* (): `xref:{class_p_bmm_open_type}[P_BMM_OPEN_TYPE]`
