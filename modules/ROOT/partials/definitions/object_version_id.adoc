...
h|*Inherit*
2+|`xref:BASE:base_types:identification_package.adoc#_uid_based_id_class[UID_BASED_ID]`
...
h|*1..1*
|*object_id* (): `xref:BASE:base_types:identification_package.adoc#_uid_class[UID]`
...
h|*1..1*
|*version_tree_id* (): `xref:BASE:base_types:identification_package.adoc#_version_tree_id_class[VERSION_TREE_ID]`
...
h|*1..1*
|*creating_system_id* (): `xref:BASE:base_types:identification_package.adoc#_uid_class[UID]`
