...
h|*1..1*
|*Average_days_in_month*: `xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]{nbsp}={nbsp}30.42`
...
h|*1..1*
|*Average_days_in_year*: `xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]{nbsp}={nbsp}365.24`
...
h|*1..1*
|*Max_timezone_hour*: `xref:BASE:foundation_types:primitive_types.adoc#_integer_class[Integer]{nbsp}={nbsp}14`
