...
h|*1..1*
|*Seconds_in_minute*: `xref:{class_integer}[Integer]{nbsp}={nbsp}60`
a|Number of seconds in a minute.

h|*1..1*
|*Minutes_in_hour*: `xref:{class_integer}[Integer]{nbsp}={nbsp}60`
a|Number of minutes in an hour.

h|*1..1*
|*Hours_in_day*: `xref:{class_integer}[Integer]{nbsp}={nbsp}24`
a|Number of clock hours in a day, i.e. 24.

h|*1..1*
|*Average_days_in_month*: `xref:{class_real}[Real]{nbsp}={nbsp}30.42`
a|Used for conversions of durations containing months to days and / or seconds.

h|*1..1*
|*Max_days_in_month*: `xref:{class_integer}[Integer]{nbsp}={nbsp}31`
a|Maximum number of days in any month.

h|*1..1*
|*Days_in_year*: `xref:{class_integer}[Integer]{nbsp}={nbsp}365`
a|Calendar days in a normal year, i.e. 365.

h|*1..1*
|*Average_days_in_year*: `xref:{class_real}[Real]{nbsp}={nbsp}365.24`
a|Used for conversions of durations containing years to days and / or seconds.

h|*1..1*
|*Days_in_leap_year*: `xref:{class_integer}[Integer]{nbsp}={nbsp}366`
a|Calendar days in a standard leap year, i.e. 366.

h|*1..1*
|*Max_days_in_year*: `xref:{class_integer}[Integer]{nbsp}={nbsp}Days_in_leap_year`
a|Maximum number of days in a year, i.e. accounting for leap years.

h|*1..1*
|*Days_in_week*: `xref:{class_integer}[Integer]{nbsp}={nbsp}7`
a|Number of days in a week.

h|*1..1*
|*Months_in_year*: `xref:{class_integer}[Integer]{nbsp}={nbsp}12`
a|Number of months in a year.

h|*1..1*
|*Min_timezone_hour*: `xref:{class_integer}[Integer]{nbsp}={nbsp}12`
a|Minimum hour value of a timezone  according to ISO 8601 (note that the -ve sign is supplied in the `ISO8601_TIMEZONE` class).

h|*1..1*
|*Max_timezone_hour*: `xref:{class_integer}[Integer]{nbsp}={nbsp}14`
a|Maximum hour value of a timezone according to ISO 8601.

h|*1..1*
|*Nominal_days_in_month*: `xref:{class_real}[Real]{nbsp}={nbsp}30.42`
a|Used for conversions of durations containing months to days and / or seconds.

h|*1..1*
|*Nominal_days_in_year*: `xref:{class_real}[Real]{nbsp}={nbsp}365.24`
a|Used for conversions of durations containing years to days and / or seconds.
