...
h|*1..1*
|*Bmm_internal_version*: `xref:{class_string}[String]{nbsp}={nbsp}`
...
h|*1..1*
|*Schema_name_delimiter*: `xref:{class_string}[String]{nbsp}={nbsp}"::"`
a|Delimiter used to separate schema id from package path in a fully qualified path.

h|*1..1*
|*Package_name_delimiter*: `xref:{class_string}[String]{nbsp}={nbsp}"."`
a|Delimiter used to separate package names in a package path.

h|*1..1*
|*Bmm_schema_file_extension*: `xref:{class_string}[String]{nbsp}={nbsp}".bmm"`
