...
h|*1..1*
|*current_date* (): `xref:{class_iso8601_date}[Iso8601_date]`
a|Return today's date in the current locale.

h|*1..1*
|*current_time* (): `xref:{class_iso8601_time}[Iso8601_time]`
a|Return current time in the current locale.

h|*1..1*
|*current_date_time* (): `xref:{class_iso8601_date_time}[Iso8601_date_time]`
a|Return current date/time in the current locale.

h|*1..1*
|*current_time_zone* (): `xref:{class_iso8601_timezone}[Iso8601_timezone]`
