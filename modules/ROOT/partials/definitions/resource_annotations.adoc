...
h|*1..1*
|*documentation*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_string}[String]>>>`
