...
h|*Inherit*
2+|`xref:BASE:bmm:core_package.adoc#_bmm_package_container_class[BMM_PACKAGE_CONTAINER]`, `xref:BASE:bmm:core_package.adoc#_bmm_model_metadata_class[BMM_MODEL_METADATA]`
...
h|*0..1*
|*class_definitions*: `xref:BASE:foundation_types:structure_types.adoc#_hash_class[Hash]<xref:BASE:foundation_types:primitive_types.adoc#_string_class[String],xref:BASE:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]>`
...
): `xref:BASE:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]`
a|Retrieve the class definition corresponding to `_a_type_name_` (which may contain a generic part).

h|*1..1*
|*type_definition* (): `xref:BASE:bmm:core_package.adoc#_bmm_class_class[BMM_CLASS]`
...
a_name: `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String][1]` +
): `xref:BASE:bmm:core_package.adoc#_bmm_enumeration_class[BMM_ENUMERATION]`
...
h|*1..1*
|*property_definition* (): `xref:BASE:bmm:core_package.adoc#_bmm_property_class[BMM_PROPERTY]`
...
h|*1..1*
|*property_definition_at_path* (): `xref:BASE:bmm:core_package.adoc#_bmm_property_class[BMM_PROPERTY]`
...
h|*1..1*
|*any_class_definition* (): `xref:BASE:bmm:core_package.adoc#_bmm_simple_class_class[BMM_SIMPLE_CLASS]`
...
h|*1..1*
|*any_type_definition* (): `xref:BASE:bmm:core_package.adoc#_bmm_simple_type_class[BMM_SIMPLE_TYPE]`
a|
|===
