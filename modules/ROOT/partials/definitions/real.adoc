...
h|*1..1*
|*floor* (): `xref:BASE:foundation_types:primitive_types.adoc#_integer_class[Integer]`
...
h|*1..1 +
(effected)*
|*negative* __alias__ "-" (): `xref:BASE:foundation_types:primitive_types.adoc#_real_class[Real]`
