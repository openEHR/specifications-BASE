...
h|*Inherit*
2+|`xref:{class_bmm_simple_class}[BMM_SIMPLE_CLASS]`
...
h|*1..1*
|*underlying_type_name*: `xref:{class_string}[String]{nbsp}={nbsp}`
...
h|*1..1*
|*name_map* (): `xref:{class_hash}[Hash]<link:/classes/String,String[String,String] >`
