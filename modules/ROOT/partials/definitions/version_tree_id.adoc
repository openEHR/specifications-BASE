...
h|*1..1*
|*trunk_version* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Trunk version number; numbering starts at 1.

h|*1..1*
|*is_branch* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|True if this version identifier represents a branch, i.e. has `_branch_number()_` and `_branch_version()_` parts.

h|*1..1*
|*is_first* (): `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|True if this version identifier corresponds to the first version, i.e. `_trunk_version_` is 1.

h|*1..1*
|*branch_number* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
a|Number of branch from the trunk point; numbering starts at 1.

h|*1..1*
|*branch_version* (): `xref:BASE:foundation_types:primitive_types.adoc#_string_class[String]`
