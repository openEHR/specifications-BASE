...
h|*Inherit*
2+|`xref:BASE:bmm:rm_access_package.adoc#_bmm_schema_descriptor_class[BMM_SCHEMA_DESCRIPTOR]`
...
h|*0..1 +
(redefined)*
|*bmm_schema*: `xref:BASE:bmm_persistence_package.adoc#_p_bmm_schema_class[P_BMM_SCHEMA]`
