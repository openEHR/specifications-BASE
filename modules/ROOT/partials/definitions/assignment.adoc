...
h|*1..1*
|*target*: `xref:BASE:expression:core_package.adoc#_variable_declaration_class[VARIABLE_DECLARATION]`
a|The target variable on the notional left-hand side of this assignment.

h|*1..1*
|*source*: `xref:BASE:expression:core_package.adoc#_expr_value_class[EXPR_VALUE]`
