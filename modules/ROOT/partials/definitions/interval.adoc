...
h|*1..1*
|*lower_unbounded*: `xref:{class_boolean}[Boolean]`
a|`lower` boundary open (i.e. = -infinity).

h|*1..1*
|*upper_unbounded*: `xref:{class_boolean}[Boolean]`
a|`upper` boundary open (i.e. = +infinity).

h|*1..1*
|*lower_included*: `xref:{class_boolean}[Boolean]`
a|`lower` boundary value included in range if not `lower_unbounded`.

h|*1..1*
|*upper_included*: `xref:{class_boolean}[Boolean]`
