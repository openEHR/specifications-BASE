...
|*to_seconds* (): `xref:{class_real}[Real]` [1..1]
...
|*add* __alias__ "+" ( +
a_val: `xref:{class_iso8601_duration}[Iso8601_duration][1]` +
...
|*negative* __alias__ "-" (): `xref:{class_iso8601_duration}[Iso8601_duration]` [1..1]
