...
|*documentation*: `xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_hash}[Hash]<xref:{class_string}[String],xref:{class_string}[String]>>>` [1..1]
