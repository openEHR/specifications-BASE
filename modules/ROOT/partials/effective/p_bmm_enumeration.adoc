...
2+|Inherits: xref:{class_p_bmm_model_element}[P_BMM_MODEL_ELEMENT], xref:{class_p_bmm_class}[P_BMM_CLASS]
...
|*bmm_class*: `xref:{class_bmm_enumeration}[BMM_ENUMERATION]` [0..1]
