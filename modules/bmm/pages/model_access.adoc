...
image::ROOT:uml/BASE-bmm.model_access.svg[id=model_access_package, align="center"]
...
image::awb_schemas_config.png[id=awb_schemas_config, align="center", width="60%"]
...
[.text-center]
.BMM schemas loaded
image::awb_loaded_bmm_schemas.png[id=awb_loaded_bmm_schemas, align="center", width="40%"]

== Class Definitions

include::ROOT:partial$classes/bmm_model_access.adoc[]
include::ROOT:partial$classes/bmm_schema_descriptor.adoc[]
include::ROOT:partial$classes/bmm_model_metadata.adoc[]
include::ROOT:partial$classes/bmm_schema.adoc[]
include::ROOT:partial$classes/bmm_schema_state.adoc[]
include::ROOT:partial$classes/bmm_include_spec.adoc[]
include::ROOT:partial$classes/p_bmm_schema_descriptor.adoc[]
