...
image::ROOT:uml/BASE-bmm.core-overview.svg[id=core_package_overview, align="center"]
...
NOTE: a future version of BMM may provide an option to import schemas using differing naming styles, with transformation into a single style for the target model.
...
include::ROOT:partial$classes/bmm_definitions.adoc[]
include::ROOT:partial$classes/bmm_model_element.adoc[]
include::ROOT:partial$classes/bmm_package_container.adoc[]
include::ROOT:partial$classes/bmm_package.adoc[]
include::ROOT:partial$classes/bmm_model.adoc[]
