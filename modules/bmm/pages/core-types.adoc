...
include::ROOT:partial$classes/bmm_type.adoc[]
include::ROOT:partial$classes/bmm_unitary_type.adoc[]
include::ROOT:partial$classes/bmm_simple_type.adoc[]
include::ROOT:partial$classes/bmm_container_type.adoc[]
include::ROOT:partial$classes/bmm_indexed_container_type.adoc[]
include::ROOT:partial$classes/bmm_generic_type.adoc[]
include::ROOT:partial$classes/bmm_parameter_type.adoc[]
