...
image::awb_class_ancestors.png[id=awb_class_ancestors, align="center", width="45%"]
...
image::awb_class_descendants.png[id=awb_class_descendants, align="center", width="45%"]
...
image::awb_generic_inheritance.png[id=awb_generic_inheritance, align="center", width="70%"]
...
image::awb_generic_inheritance_closed.png[id=awb_generic_inheritance_closed, align="center", width="85%"]
...
image::awb_generic_inheritance_mixed.png[id=awb_generic_inheritance_mixed, align="center", width="90%"]
...
[.text-center]
.Multiple inheritance
image::awb_multiple_inheritance.png[id=awb_multiple_inheritance, align="center", width="45%"]
