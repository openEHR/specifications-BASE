...
[.text-center]
.resource Package
image::ROOT:uml/BASE-resource.svg[id=resource_package, align="center"]
...
include::ROOT:partial$classes/authored_resource.adoc[]

include::ROOT:partial$classes/translation_details.adoc[]

include::ROOT:partial$classes/resource_description.adoc[]

include::ROOT:partial$classes/resource_description_item.adoc[]

include::ROOT:partial$classes/resource_annotations.adoc[]
